...
inoremap <C-B> :!./build.sh
inoremap <F5> :YcmForceCompileAndDiagnostics
inoremap <C-L> <Plug>(YCMToggleSignatureHelp)
inoremap <C-G> :vertical YcmCompleter GoTo
inoremap <F4> :YcmCompleter GoToAlternateFile
inoremap <C-R> :red
inoremap <C-Z> :u
inoremap <C-_> :s!^!//!
inoremap <C-K> ddkP
inoremap <C-J> ddp
inoremap <M-F4> :tabclose
inoremap <M-Left> :tabprevious
inoremap <M-Right> :tabnext
inoremap <F2> :w
nnoremap <silent> w :CCTreeWindowToggle
nnoremap <silent> y :CCTreeWindowSaveCopy
nnoremap  d :YcmShowDetailedDiagnostic
nnoremap  t :TabsPopup
nnoremap  jh <Plug>(YCMCallHierarchy)
nnoremap  jt <Plug>(YCMTypeHierarchy)
nnoremap  jg <Plug>(YCMFindSymbolInDocument)
nnoremap  jf <Plug>(YCMFindSymbolInWorkspace)
...
nnoremap <F6> :YcmCompleter FixIt
nnoremap <C-?> <Plug>(YCMHover)
noremap <F4> :q
inoremap  :!./build.sh
inoremap  :vertical YcmCompleter GoTo
inoremap <expr> 	 pumvisible() ? "\" : "\	"
inoremap <NL> ddp
inoremap  ddkP
inoremap  <Plug>(YCMToggleSignatureHelp)
inoremap  :red
inoremap  :u
inoremap  :s!^!//!
let &cpo=s:cpo_save
...
set completeopt=menuone,noinsert,popup,noselect,popuphidden
...
set ruler
set runtimepath=~/.vim,~/.vim/plugged/YouCompleteMe,~/.vim/plugged/lightline.vim,~/.vim/plugged/gruvbox,~/.vim/plugged/YCM-Generator,~/.vim/plugged/DoxygenToolkit.vim,/usr/share/vim/vimfiles,/usr/share/vim/vim90,/usr/share/vim/vimfiles/after,~/.vim/after
set scrolloff=8
set shiftwidth=4
...
badd +1 ~/.vimrc
badd +33 include/app.h
badd +1 ~/projekt/ch355
badd +17 src/chessboard.cpp
badd +23 include/chessboard.h
argglobal
%argdel
$argadd ~/projekt/ch355
...
lcd ~/projekt/ch355
tabnext
edit ~/projekt/ch355/src/chessboard.cpp
argglobal
balt ~/projekt/ch355/include/chessboard.h
nnoremap <buffer> <silent> - :CCTreeRecurseDepthMinus
nnoremap <buffer> <silent> = :CCTreeRecurseDepthPlus
let s:cpo_save=&cpo
set cpo&vim
...
lcd ~/projekt/ch355
tabnext
edit ~/projekt/ch355/src/main.cpp
argglobal
balt ~/projekt/ch355/src/app.cpp
nnoremap <buffer> <silent> - :CCTreeRecurseDepthMinus
nnoremap <buffer> <silent> = :CCTreeRecurseDepthPlus
let s:cpo_save=&cpo
set cpo&vim
...
lcd ~/projekt/ch355
tabnext
edit ~/projekt/ch355/CMakeLists.txt
argglobal
balt ~/projekt/ch355/src/main.cpp
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
edit ~/.vimrc
argglobal
balt ~/projekt/ch355/CMakeLists.txt
...
silent! normal! zE
let &fdl = &fdl
let s:l = 106 - ((29 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 106
